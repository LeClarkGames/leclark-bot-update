...
# --- The Persistent Verification Button View ---
class VerificationButton(discord.ui.View):
    ...
    async def verify_button(self, interaction: discord.Interaction, button: discord.ui.Button):
        member_role_id = await database.get_setting(interaction.guild.id, 'member_role_id')
        if member_role_id in [r.id for r in interaction.user.roles]:
        ...
        if mode == 'captcha':
            ...
            if mode == 'twitch':
                ...
                redirect_uri = "http://127.0.0.1:5000/callback/twitch"
                ...
                redirect_uri = "http://127.0.0.1:5000/callback/youtube"
