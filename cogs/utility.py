...
class ChannelSelectForSend(discord.ui.ChannelSelect):
    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        try:
            ...
            await original_message.edit(content="*This embed has been sent and the builder is now inactive.*", view=None)
        except discord.Forbidden:
            await interaction.response.edit_message(content=f"❌ I do not have permission to send messages in {channel.mention}.", view=None)
